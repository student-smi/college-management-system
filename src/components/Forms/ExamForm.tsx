...
import { examschema, Examschema, subjectschema, Subjectschema } from "@/lib/FromSchemaValidetion";
...
const ExamForm = ({
  ...
  // ✅ safe guard
  const {lessons , class:classname}= renderData

  return (
    <form onSubmit={onsubmit} className="flex flex-col gap-8">
      <h1 className="text-xl font-semibold">
        {type === "create" ? "Create a exam" : "Update a exam"}
      </h1>
